        ...
        try {
            ...
            Pair_Code_By_Arslan_Tech.ev.on('connection.update', async (s) => {
                ...
                if (connection === 'open') {
                    ...
                    let session = await Pair_Code_By_Arslan_Tech.sendMessage(Pair_Code_By_Arslan_Tech.user.id, { text: 'RAJAR-MD~' + b64data });
...
║ 『••• _V𝗶𝘀𝗶𝘁 𝗙𝗼𝗿_H𝗲𝗹𝗽 •••』
║❍ 𝐎𝐰𝐧𝐞𝐫: 923004942595
║❍ 𝐖𝐚𝐂𝐡𝐚𝐧𝐧𝐞𝐥: https://whatsapp.com/channel/0029Vb76vbVFSAswRsZAp31g
║
║ ☬ ☬ ☬ ☬
╚═════════════════════╝
𒂀 Enjoy RaJaR-MD
